...
* A Dark Kingdom - Automated Agent Roster

This document contains the core directives for the 11 specialized AI personas that maintain, expand, and balance "A Dark Kingdom".
